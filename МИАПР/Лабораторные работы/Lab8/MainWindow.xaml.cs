...
using Lab8.grammar;
using Point = Lab8.grammar.Point;

namespace Lab8;

using Point = grammar.Point;
...
public partial class MainWindow : Window
{
    ...
    void Generate_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show("Нет грамматики", "ой-йой", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
    ...
    void Synthesize_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show(ex.Message, "ой-йой", MessageBoxButton.OK, MessageBoxImage.Error);
            GrammarLabel.Content = "";
            _grammar = null;
        }      
    }
